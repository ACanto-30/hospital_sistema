    ...
    <div class="dashboard-page dashboard-cashier">
        ...
        <div class="summary-grid">
            ...
            <div class="summary-card <?= $statusFilter === 'processed' ? 'active-tab' : '' ?>" onclick="window.location='?status=processed'" style="cursor: pointer;">
                <div class="card-content">
                    <div class="card-info">
                        ...
                        <p class="muted">Año: <?= (int) $resumen['pagos_procesados_anio'] ?></p>
                    </div>
                    <div class="card-icon"><span>✅</span></div>
                </div>
            </div>
            ...
            <div class="summary-card stats-card" onclick="window.location='?status=all'" style="cursor: pointer;">
                <div class="card-content">
                    <div class="card-info">
                        <strong class="section-title">Cobrado este Año</strong>
                        <p class="muted">B/. <?= number_format((float) $resumen['cobrado_anio'], 2) ?></p>
                    </div>
                    <div class="card-icon"><span>💰</span></div>
                </div>
            </div>
...
<style>
    ...
    /* Utilities */
    .dashboard-page.dashboard-cashier .d-block {
        display: block;
    }

    .dashboard-page.dashboard-cashier .mb-2 {
        margin-bottom: 0.5rem;
    }

    .dashboard-page.dashboard-cashier .mb-4 {
        margin-bottom: 1.5rem;
    }

    .dashboard-page.dashboard-cashier .muted {
        color: #64748b;
    }

    .dashboard-page.dashboard-cashier .small {
        font-size: 0.85rem;
    }
</style>
