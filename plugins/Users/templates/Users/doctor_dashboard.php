...
<div class="dashboard-page dashboard-doctor">
    ...
    <!-- Summary Grid (Estilo Premium/Cashier) -->
...
<style>
    /* Estilos Premium (Basados en Dashboard Cajero) */
    .dashboard-page {
        padding: 20px 0;
        max-width: 100%;
        /* Asegurar ancho completo relativo al contenedor */
    }
    ...
    .main-card {
        ...
        /* Toque premium en el borde superior */
    }
